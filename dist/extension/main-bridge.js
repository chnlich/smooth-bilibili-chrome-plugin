(() => {
  ...
  function pagePlayerObject() {
    ...
    for (const iframe of document.querySelectorAll("iframe")) {
      try {
        ...
        if (iframePlayer !== void 0 && iframePlayer !== null && (typeof iframePlayer === "object" || typeof iframePlayer === "function")) {
          return iframePlayer;
        }
      } catch {
      }
  ...
  function livePlayerCandidates() {
    ...
    return candidates.filter((candidate) => candidate !== void 0 && candidate !== null);
  }
